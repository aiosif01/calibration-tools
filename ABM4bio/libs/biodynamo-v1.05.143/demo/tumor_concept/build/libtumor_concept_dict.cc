...
#define R__DICTIONARY_FILENAME dIhomedIaiwsifdIDesktopdIABM4biodIlibsdIbiodynamomIv1dO05dO143dIdemodItumor_conceptdIbuilddIlibtumor_concept_dict
...
#include "/home/aiwsif/Desktop/ABM4bio/libs/biodynamo-v1.05.143/demo/tumor_concept/src/tumor_concept.h"
...
namespace bdm {
   ...
   namespace ROOTDict {
      inline ::ROOT::TGenericClassInfo *GenerateInitInstance();
      static TClass *bdmcLcLtumor_concept_Dictionary();

      // Function generating the singleton type initializer
      inline ::ROOT::TGenericClassInfo *GenerateInitInstance()
      {
         static ::ROOT::TGenericClassInfo 
            instance("bdm::tumor_concept", 0 /*version*/, "", 38,
                     ::ROOT::Internal::DefineBehavior((void*)nullptr,(void*)nullptr),
                     &bdmcLcLtumor_concept_Dictionary, 0);
         return &instance;
      }
      // Insure that the inline function is _not_ optimized away by the compiler
      ::ROOT::TGenericClassInfo *(*_R__UNIQUE_DICT_(InitFunctionKeeper))() = &GenerateInitInstance;  
...
namespace ROOT {
   static void *new_bdmcLcLtumor_conceptcLcLMyCell(void *p = nullptr);
   static void delete_bdmcLcLtumor_conceptcLcLMyCell(void *p);
   static void deleteArray_bdmcLcLtumor_conceptcLcLMyCell(void *p);
   static void destruct_bdmcLcLtumor_conceptcLcLMyCell(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::bdm::tumor_concept::MyCell*)
   {
      ::bdm::tumor_concept::MyCell *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::bdm::tumor_concept::MyCell >(nullptr);
      static ::ROOT::TGenericClassInfo 
         instance("bdm::tumor_concept::MyCell", ::bdm::tumor_concept::MyCell::Class_Version(), "", 42,
                  typeid(::bdm::tumor_concept::MyCell), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::bdm::tumor_concept::MyCell::Dictionary, isa_proxy, 4,
                  sizeof(::bdm::tumor_concept::MyCell) );
      instance.SetNew(&new_bdmcLcLtumor_conceptcLcLMyCell);
      instance.SetDelete(&delete_bdmcLcLtumor_conceptcLcLMyCell);
      instance.SetDeleteArray(&deleteArray_bdmcLcLtumor_conceptcLcLMyCell);
      instance.SetDestructor(&destruct_bdmcLcLtumor_conceptcLcLMyCell);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::bdm::tumor_concept::MyCell*)
   {
      return GenerateInitInstanceLocal(static_cast<::bdm::tumor_concept::MyCell*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::bdm::tumor_concept::MyCell*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

namespace ROOT {
   static void *new_bdmcLcLtumor_conceptcLcLGrowth(void *p = nullptr);
   static void *newArray_bdmcLcLtumor_conceptcLcLGrowth(Long_t size, void *p);
   static void delete_bdmcLcLtumor_conceptcLcLGrowth(void *p);
   static void deleteArray_bdmcLcLtumor_conceptcLcLGrowth(void *p);
   static void destruct_bdmcLcLtumor_conceptcLcLGrowth(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::bdm::tumor_concept::Growth*)
   {
      ::bdm::tumor_concept::Growth *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::bdm::tumor_concept::Growth >(nullptr);
      static ::ROOT::TGenericClassInfo 
         instance("bdm::tumor_concept::Growth", ::bdm::tumor_concept::Growth::Class_Version(), "", 81,
                  typeid(::bdm::tumor_concept::Growth), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::bdm::tumor_concept::Growth::Dictionary, isa_proxy, 4,
                  sizeof(::bdm::tumor_concept::Growth) );
      instance.SetNew(&new_bdmcLcLtumor_conceptcLcLGrowth);
      instance.SetNewArray(&newArray_bdmcLcLtumor_conceptcLcLGrowth);
      instance.SetDelete(&delete_bdmcLcLtumor_conceptcLcLGrowth);
      instance.SetDeleteArray(&deleteArray_bdmcLcLtumor_conceptcLcLGrowth);
      instance.SetDestructor(&destruct_bdmcLcLtumor_conceptcLcLGrowth);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::bdm::tumor_concept::Growth*)
   {
      return GenerateInitInstanceLocal(static_cast<::bdm::tumor_concept::Growth*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::bdm::tumor_concept::Growth*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
{
   return "bdm::tumor_concept::MyCell";
}

//______________________________________________________________________________
const char *MyCell::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::bdm::tumor_concept::MyCell*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int MyCell::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::bdm::tumor_concept::MyCell*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *MyCell::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::bdm::tumor_concept::MyCell*)nullptr)->GetClass();
   return fgIsA;
}
...
TClass *MyCell::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::bdm::tumor_concept::MyCell*)nullptr)->GetClass(); }
   return fgIsA;
}

} // namespace bdm::tumor_concept
} // namespace bdm::tumor_concept
namespace bdm {
   namespace tumor_concept {
//______________________________________________________________________________
...
{
   return "bdm::tumor_concept::Growth";
}

//______________________________________________________________________________
const char *Growth::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::bdm::tumor_concept::Growth*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int Growth::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::bdm::tumor_concept::Growth*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *Growth::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::bdm::tumor_concept::Growth*)nullptr)->GetClass();
   return fgIsA;
}
...
TClass *Growth::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::bdm::tumor_concept::Growth*)nullptr)->GetClass(); }
   return fgIsA;
}
...
{
   // Stream an object of class bdm::tumor_concept::MyCell.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(bdm::tumor_concept::MyCell::Class(),this);
   } else {
      R__b.WriteClassBuffer(bdm::tumor_concept::MyCell::Class(),this);
   }
}
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_bdmcLcLtumor_conceptcLcLMyCell(void *p) {
      return  p ? ::new(static_cast<::ROOT::Internal::TOperatorNewHelper*>(p)) ::bdm::tumor_concept::MyCell( (TRootIOCtor *)nullptr ) : new ::bdm::tumor_concept::MyCell( (TRootIOCtor *)nullptr );
   }
   // Wrapper around operator delete
   static void delete_bdmcLcLtumor_conceptcLcLMyCell(void *p) {
      delete (static_cast<::bdm::tumor_concept::MyCell*>(p));
   }
   static void deleteArray_bdmcLcLtumor_conceptcLcLMyCell(void *p) {
      delete [] (static_cast<::bdm::tumor_concept::MyCell*>(p));
   }
   static void destruct_bdmcLcLtumor_conceptcLcLMyCell(void *p) {
      typedef ::bdm::tumor_concept::MyCell current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class ::bdm::tumor_concept::MyCell
...
{
   // Stream an object of class bdm::tumor_concept::Growth.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(bdm::tumor_concept::Growth::Class(),this);
   } else {
      R__b.WriteClassBuffer(bdm::tumor_concept::Growth::Class(),this);
   }
}
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_bdmcLcLtumor_conceptcLcLGrowth(void *p) {
      return  p ? ::new(static_cast<::ROOT::Internal::TOperatorNewHelper*>(p)) ::bdm::tumor_concept::Growth : new ::bdm::tumor_concept::Growth;
   }
   static void *newArray_bdmcLcLtumor_conceptcLcLGrowth(Long_t nElements, void *p) {
      return p ? ::new(static_cast<::ROOT::Internal::TOperatorNewHelper*>(p)) ::bdm::tumor_concept::Growth[nElements] : new ::bdm::tumor_concept::Growth[nElements];
   }
   // Wrapper around operator delete
   static void delete_bdmcLcLtumor_conceptcLcLGrowth(void *p) {
      delete (static_cast<::bdm::tumor_concept::Growth*>(p));
   }
   static void deleteArray_bdmcLcLtumor_conceptcLcLGrowth(void *p) {
      delete [] (static_cast<::bdm::tumor_concept::Growth*>(p));
   }
   static void destruct_bdmcLcLtumor_conceptcLcLGrowth(void *p) {
      typedef ::bdm::tumor_concept::Growth current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class ::bdm::tumor_concept::Growth
...
namespace {
  void TriggerDictionaryInitialization_libtumor_concept_dict_Impl() {
...
#line 1 "libtumor_concept_dict dictionary forward declarations' payload"
...
namespace bdm{namespace tumor_concept{class MyCell;}}
namespace bdm{namespace tumor_concept{struct Growth;}}
)DICTFWDDCLS";
    static const char* payloadCode = R"DICTPAYLOAD(
#line 1 "libtumor_concept_dict dictionary payload"

#ifndef BDMSYS
  #define BDMSYS /home/aiwsif/Desktop/ABM4bio/libs/biodynamo-v1.05.143
#endif
#ifndef USE_MPI
  #define USE_MPI 1
#endif
...
"bdm::tumor_concept::Growth", payloadCode, "@",
"bdm::tumor_concept::MyCell", payloadCode, "@",
nullptr
};
    static bool isInitialized = false;
    if (!isInitialized) {
      TROOT::RegisterModule("libtumor_concept_dict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_libtumor_concept_dict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_libtumor_concept_dict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_libtumor_concept_dict() {
  TriggerDictionaryInitialization_libtumor_concept_dict_Impl();
}

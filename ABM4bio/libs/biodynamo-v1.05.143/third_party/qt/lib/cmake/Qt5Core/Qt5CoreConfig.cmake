...
set(Qt5Core_VERSION_STRING 5.12.10)
...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/QtCore/5.12.10"
        "${_qt5Core_install_prefix}/include/QtCore/5.12.10/QtCore"
    )
    ...
    foreach(_module_dep ${_Qt5Core_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.10 ${_Qt5Core_FIND_VERSION_EXACT}
    ...
    _populate_Core_target_properties(RELEASE "libQt5Core.so.5.12.10" "" )

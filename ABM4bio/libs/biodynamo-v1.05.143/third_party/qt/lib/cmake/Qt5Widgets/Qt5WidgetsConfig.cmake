...
set(Qt5Widgets_VERSION_STRING 5.12.10)
...
if (NOT TARGET Qt5::Widgets)
    ...
    set(Qt5Widgets_PRIVATE_INCLUDE_DIRS
        "${_qt5Widgets_install_prefix}/include/QtWidgets/5.12.10"
        "${_qt5Widgets_install_prefix}/include/QtWidgets/5.12.10/QtWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5Widgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.10 ${_Qt5Widgets_FIND_VERSION_EXACT}
    ...
    _populate_Widgets_target_properties(RELEASE "libQt5Widgets.so.5.12.10" "" )

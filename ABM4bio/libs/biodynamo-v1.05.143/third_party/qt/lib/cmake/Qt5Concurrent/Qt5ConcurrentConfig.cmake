...
set(Qt5Concurrent_VERSION_STRING 5.12.10)
...
if (NOT TARGET Qt5::Concurrent)
    ...
    foreach(_module_dep ${_Qt5Concurrent_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.10 ${_Qt5Concurrent_FIND_VERSION_EXACT}
    ...
    _populate_Concurrent_target_properties(RELEASE "libQt5Concurrent.so.5.12.10" "" )

...
set(Qt5Gui_VERSION_STRING 5.12.10)
...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/QtGui/5.12.10"
        "${_qt5Gui_install_prefix}/include/QtGui/5.12.10/QtGui"
    )
    ...
    foreach(_module_dep ${_Qt5Gui_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.10 ${_Qt5Gui_FIND_VERSION_EXACT}
    ...
    _populate_Gui_target_properties(RELEASE "libQt5Gui.so.5.12.10" "" )

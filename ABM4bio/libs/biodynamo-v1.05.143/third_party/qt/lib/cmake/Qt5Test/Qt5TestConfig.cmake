...
set(Qt5Test_VERSION_STRING 5.12.10)
...
if (NOT TARGET Qt5::Test)
    ...
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/include/QtTest/5.12.10"
        "${_qt5Test_install_prefix}/include/QtTest/5.12.10/QtTest"
    )
    ...
    foreach(_module_dep ${_Qt5Test_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.10 ${_Qt5Test_FIND_VERSION_EXACT}
    ...
    _populate_Test_target_properties(RELEASE "libQt5Test.so.5.12.10" "" )

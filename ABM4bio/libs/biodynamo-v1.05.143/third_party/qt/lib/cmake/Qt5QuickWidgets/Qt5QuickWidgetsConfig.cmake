...
set(Qt5QuickWidgets_VERSION_STRING 5.12.10)
...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    set(Qt5QuickWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickWidgets_install_prefix}/include/QtQuickWidgets/5.12.10"
        "${_qt5QuickWidgets_install_prefix}/include/QtQuickWidgets/5.12.10/QtQuickWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5QuickWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.10 ${_Qt5QuickWidgets_FIND_VERSION_EXACT}
    ...
    _populate_QuickWidgets_target_properties(RELEASE "libQt5QuickWidgets.so.5.12.10" "" )

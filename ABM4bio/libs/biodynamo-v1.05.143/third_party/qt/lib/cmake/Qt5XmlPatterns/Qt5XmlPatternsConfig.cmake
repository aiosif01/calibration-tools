...
set(Qt5XmlPatterns_VERSION_STRING 5.12.10)
...
if (NOT TARGET Qt5::XmlPatterns)
    ...
    set(Qt5XmlPatterns_PRIVATE_INCLUDE_DIRS
        "${_qt5XmlPatterns_install_prefix}/include/QtXmlPatterns/5.12.10"
        "${_qt5XmlPatterns_install_prefix}/include/QtXmlPatterns/5.12.10/QtXmlPatterns"
    )
    ...
    foreach(_module_dep ${_Qt5XmlPatterns_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.10 ${_Qt5XmlPatterns_FIND_VERSION_EXACT}
    ...
    _populate_XmlPatterns_target_properties(RELEASE "libQt5XmlPatterns.so.5.12.10" "" )

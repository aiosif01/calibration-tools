...
set(Qt5OpenGL_VERSION_STRING 5.12.10)
...
if (NOT TARGET Qt5::OpenGL)
    ...
    set(Qt5OpenGL_PRIVATE_INCLUDE_DIRS
        "${_qt5OpenGL_install_prefix}/include/QtOpenGL/5.12.10"
        "${_qt5OpenGL_install_prefix}/include/QtOpenGL/5.12.10/QtOpenGL"
    )
    ...
    foreach(_module_dep ${_Qt5OpenGL_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.10 ${_Qt5OpenGL_FIND_VERSION_EXACT}
    ...
    _populate_OpenGL_target_properties(RELEASE "libQt5OpenGL.so.5.12.10" "" )

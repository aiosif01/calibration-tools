...
set(Qt5WaylandCompositor_VERSION_STRING 5.12.10)
...
if (NOT TARGET Qt5::WaylandCompositor)
    ...
    set(Qt5WaylandCompositor_PRIVATE_INCLUDE_DIRS
        "${_qt5WaylandCompositor_install_prefix}/include/QtWaylandCompositor/5.12.10"
        "${_qt5WaylandCompositor_install_prefix}/include/QtWaylandCompositor/5.12.10/QtWaylandCompositor"
    )
    ...
    foreach(_module_dep ${_Qt5WaylandCompositor_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.10 ${_Qt5WaylandCompositor_FIND_VERSION_EXACT}
    ...
    _populate_WaylandCompositor_target_properties(RELEASE "libQt5WaylandCompositor.so.5.12.10" "" )

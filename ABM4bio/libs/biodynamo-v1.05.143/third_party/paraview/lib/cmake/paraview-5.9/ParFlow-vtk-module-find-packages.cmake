...
if (_vtk_module_find_package_components)
  if ("IO" IN_LIST _vtk_module_find_package_components)
    set(_vtk_module_find_package_enabled ON)
    if ("IO" IN_LIST _vtk_module_find_package_components_required)
...
if (_vtk_module_find_package_enabled)
  ...
  if (NOT nlohmann_json_FOUND AND _vtk_module_find_package_fail_if_not_found)
    ...
    set("${CMAKE_FIND_PACKAGE_NAME}_IO_FOUND" 0)
    list(APPEND "${CMAKE_FIND_PACKAGE_NAME}_IO_NOT_FOUND_MESSAGE"

 ...
 */
#define VKL_VDB_LOG_RES_3       3
#define VKL_VDB_STORAGE_RES_3   8
#define VKL_VDB_NUM_VOXELS_3    512
#define VKL_VDB_TOTAL_LOG_RES_3 3
#define VKL_VDB_RES_3           8
...
#include "topology_4.h"

#else

#define VKL_VDB_LOG_RES_4       0
#define VKL_VDB_STORAGE_RES_4   1
#define VKL_VDB_NUM_VOXELS_4    1
#define VKL_VDB_TOTAL_LOG_RES_4 0
#define VKL_VDB_RES_4           1

#define __vkl_vdb_iterate_levels_4(Macro, ...)

#endif // 4 < VKL_VDB_NUM_LEVELS
...
#define __vkl_vdb_iterate_levels_3(Macro, ...)                          \
  __vkl_vdb_expand(__vkl_vdb_iterate_levels_4(Macro, __VA_ARGS__)) \
  __vkl_vdb_expand(Macro(3, __VA_ARGS__))
 ...
 */
#define __vkl_vdb_domain_offset_to_voxel_uniform_3(offset)           \
  ((VKL_INTEROP_UNIFORM vkl_uint64) ((offset) & (VKL_VDB_RES_3 - 1)) \
    >> VKL_VDB_TOTAL_LOG_RES_4)

#if defined(ISPC)

#define __vkl_vdb_domain_offset_to_voxel_varying_3(offset) \
  ((varying vkl_uint64) ((offset) & (VKL_VDB_RES_3 - 1))   \
    >> VKL_VDB_TOTAL_LOG_RES_4)
 ...
 */
#define __vkl_vdb_3d_to_linear_uniform_3(offx, offy, offz)              \
   ((((VKL_INTEROP_UNIFORM vkl_uint64)offx) << (2 * VKL_VDB_LOG_RES_3)) \
  + (((VKL_INTEROP_UNIFORM vkl_uint64)offy) <<      VKL_VDB_LOG_RES_3 ) \
  + (((VKL_INTEROP_UNIFORM vkl_uint64)offz)))

#if defined(ISPC)

#define __vkl_vdb_3d_to_linear_varying_3(offx, offy, offz)  \
   ((((varying vkl_uint64)offx) << (2 * VKL_VDB_LOG_RES_3)) \
  + (((varying vkl_uint64)offy) <<      VKL_VDB_LOG_RES_3 ) \
 ...
 * macros.
 */
#define __vkl_vdb_domain_offset_to_linear_uniform_3(offx, offy, offz) \
  __vkl_vdb_3d_to_linear_uniform_3(                                   \
    __vkl_vdb_domain_offset_to_voxel_uniform_3(offx),                 \
    __vkl_vdb_domain_offset_to_voxel_uniform_3(offy),                 \
    __vkl_vdb_domain_offset_to_voxel_uniform_3(offz))

#if defined(ISPC)

#define __vkl_vdb_domain_offset_to_linear_varying_3(offx, offy, offz) \
  __vkl_vdb_3d_to_linear_varying_3(                                   \
    __vkl_vdb_domain_offset_to_voxel_varying_3(offx),                 \
    __vkl_vdb_domain_offset_to_voxel_varying_3(offy),                 \
    __vkl_vdb_domain_offset_to_voxel_varying_3(offz))

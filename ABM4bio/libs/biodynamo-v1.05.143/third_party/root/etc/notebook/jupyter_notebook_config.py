...
if 'JSROOTSYS' in os.environ:
    ...
    c.NotebookApp.extra_static_paths.append(os.path.join("/home/rdm/root-cxx17-py3.9-bdm/root", "js"))
    c.ServerApp.extra_static_paths.append(os.path.join("/home/rdm/root-cxx17-py3.9-bdm/root", "js"))

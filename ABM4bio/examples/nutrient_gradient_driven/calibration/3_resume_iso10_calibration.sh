...
# Usage:
#   ./3_resume_iso10_calibration.sh [n_trials] [seed] [db_name]
# Example:
#   ./3_resume_iso10_calibration.sh 200 1234 study_iso10_fresh.db
...
LOCK_FILE="/tmp/abm4bio_iso10_calibration_${USER}.lock"
